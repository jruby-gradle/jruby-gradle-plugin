...
class JRubyJarTestKitSpec extends Specification {
    ...
    File buildFile
    File rubyFile
    StringWriter testStdout = new StringWriter()
...
"""
        ...
        and:
        testStdout.toString().contains('Hello from JRuby')
    }
